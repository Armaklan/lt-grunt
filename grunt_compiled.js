...
}catch (e7853){var e = e7853;lt.plugins.grunt.log.call(null,"Impossible de trouver grunt");
return [];
}});
...
lt.plugins.grunt.run_task_process = (function run_task_process(task){var grunt_cmd = lt.plugins.grunt.concatener.call(null,lt.plugins.grunt.current_modules.call(null),"/grunt-cli/bin/grunt --no-color ");var child = require("child_process").exec(lt.plugins.grunt.concatener.call(null,grunt_cmd,new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(task)),((function (grunt_cmd){
return (function (err,stdout,stderr){if(cljs.core.seq.call(null,err))
{return cljs.core.println.call(null,err);
} else
{return null;
}
});})(grunt_cmd))
);child.stdout.on("data",((function (child,grunt_cmd){
...
lt.plugins.grunt.selector = (function selector(opts){var G__7855 = lt.objs.sidebar.command.filter_list.call(null,opts);lt.object.add_behavior_BANG_.call(null,G__7855,new cljs.core.Keyword("lt.plugins.grunt","set-selected","lt.plugins.grunt/set-selected",3339425851));
return G__7855;
});
lt.plugins.grunt.add_selector = (function add_selector(){return lt.plugins.grunt.selector.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"items","items",1114430258),lt.plugins.grunt.get_tasks.call(null),new cljs.core.Keyword(null,"key","key",1014010321),new cljs.core.Keyword(null,"name","name",1017277949),new cljs.core.Keyword(null,"placeholder","placeholder",1612151013),"Grunt target",new cljs.core.Keyword(null,"transform","transform",2066570974),(function (p1__7857_SHARP_,p2__7858_SHARP_,p3__7859_SHARP_,p4__7856_SHARP_){return [cljs.core.str("<p>"),cljs.core.str(new cljs.core.Keyword(null,"name","name",1017277949).cljs$core$IFn$_invoke$arity$1(p4__7856_SHARP_)),cljs.core.str("</p>"),cljs.core.str("<p class='binding'>"),cljs.core.str(new cljs.core.Keyword(null,"description","description",3584325486).cljs$core$IFn$_invoke$arity$1(p4__7856_SHARP_)),cljs.core.str("</p>")].join('');
})], null));
});
...
{var process = temp__4126__auto__;lt.plugins.grunt.log.call(null,"Kill process : ");
process.kill();
